...
try {
  ...
  run(
    "workout report snapshot stores only the session date matches",
    () => {
      resetStore(8, 1);
      const today =
      ...
      useMatchStore.setState({
        matchHistory: [
          ...
          },
          {
            ...
            startedAt:
              new Date(
                `${today}T20:00:00+09:00`
              ),
            endedAt:
              new Date(
                `${today}T20:15:00+09:00`
              ),
          },
        ],
        workoutReportEvents: [
      ...
      assert.deepEqual(
        snapshot.workoutReportEvents.map(
          (event) => event.id
        ),
        ["today-event"]
      );
  ...
  run(
    "workout report snapshot uses latest match date when current clock differs",
    () => {
      resetStore(8, 1);
      ...
      useMatchStore.setState({
        matchHistory: [
          ...
          },
          {
            ...
            startedAt:
              new Date(
                "2026-07-03T20:00:00+09:00"
              ),
            endedAt:
              new Date(
                "2026-07-03T20:15:00+09:00"
              ),
          },
        ],
        workoutReportEvents: [
